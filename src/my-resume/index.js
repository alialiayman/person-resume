...
const MyResume = ({ userId }) => {
  ...
  const handleAddContactInfo = () => {
    if (newContactInfo.trim()) {
      setResumeData((prevData) => ({ ...prevData, contactInfo: newContactInfo }));
      setNewContactInfo("");
    }
  };
  ...
  const handleAddSkill = () => {
    if (newSkill.trim()) {
      setResumeData((prevData) => ({ ...prevData, skills: [...prevData.skills, newSkill] }));
      setNewSkill("");
    }
  };
        ...
        <Card>
          <CardContent>
            ...
            {resumeData?.education ? (
              ...
              <Button onClick={handleAddEducation}>Add Your First Education</Button>
            )}
            <TextField
              fullWidth
              value={newEducation}
        ...
        <Card>
          <CardContent>
            ...
            {resumeData?.overview ? (
              ...
              <Button onClick={handleAddOverview}>Add Your First Overview</Button>
            )}
            <TextField
              fullWidth
              value={newOverview}
        ...
        <Card>
          <CardContent>
            ...
            {resumeData?.contactInfo ? (
              ...
              <Button onClick={handleAddContactInfo}>Add Your First Contact Info</Button>
            )}
            <TextField
              fullWidth
        ...
        <Card>
          <CardContent>
            ...
            {resumeData?.previousEmployers.length > 0 ? (
              resumeData.previousEmployers.map((employer, index) => (
                <Typography key={index} variant="body1">
                  {employer.position} at {employer.company} ({employer.date}) - {employer.location}
                </Typography>
              ))
            ) : (
              <Button onClick={handleAddPreviousEmployer}>Add Your First Employer</Button>
            )}
            <TextField
              label="Company"
            ...
            <TextField
              ...
              onChange={(e) => setNewEmployer({ ...newEmployer, date: e.target.value })}
              variant="outlined"
              style={{ marginTop: 10 }}
            />
            <TextField
              ...
              style={{ marginTop: 10 }}
            />
            <Button onClick={handleAddPreviousEmployer} style={{ marginTop: 10 }}>
              Add Employer
            </Button>
          </CardContent>
        </Card>
